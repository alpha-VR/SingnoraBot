...
if OCR_API_KEY == None:
	with open('./tokens/OCR_API_KEY.token','r') as token:
	...
	async with aiohttp.ClientSession() as session:
		async with session.get(url) as r:
			...
			if size > 1e6:
				...
				if size > 1e6 or os.path.splitext(url)[1] == '.jpg':
...
if __name__ == '__main__':
	...
	url = 'https://cdn.discordapp.com/attachments/789852768777011230/859422197685026826/Screenshot_20210629-145725.jpg'
	lang = tr.en()
